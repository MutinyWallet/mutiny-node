...
pub enum MutinyJsError {
    ...
    PayjoinConfigError,
    /// Failed to call on the given Cashu mint URL
    #[error("Failed to call on the given Cashu mint URL.")]
    CashuMintUrlFailure,
    /// Unknown error.
    #[error("Unknown Error")]
    UnknownError,
...
impl From<MutinyError> for MutinyJsError {
    fn from(e: MutinyError) -> Self {
        match e {
            ...
            MutinyError::CashuMintUrlFailure => MutinyJsError::CashuMintUrlFailure,
            MutinyError::Other(e) => {
...
impl From<moksha_core::error::MokshaCoreError> for MutinyJsError {
    fn from(_e: moksha_core::error::MokshaCoreError) -> Self {
        MutinyError::from(e).into()
    }
}
